...
/**
 * This class contains all the constant values used for the evaluation.
 * 
 *
 */
public class Constants {

	public static final int INSTANT_REJECT_GPA_SCORE = 70;
	public static final int INSTANT_ACCEPT_GPA_SCORE = 90;
	public static final int INDEX_FOR_FIRST_NAME_REJECT = 0;
	public static final int INDEX_FOR_LAST_NAME_REJECT = 0;
	public static final String INSTANT_REJECT_FELONY_REASON = "Rejected due to felony";
	public static final String INSTANT_REJECT_GPA_LESS = "GPA < 70";
